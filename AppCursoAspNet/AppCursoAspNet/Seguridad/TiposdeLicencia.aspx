...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="NuevoTipodeLicencia.aspx" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>Agregar Tipo de Licencia</asp:HyperLink>
    </p>
    <form runat="server">
