...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Grupos</h2>
    <p>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/View/NuevoGrupo.aspx" class="btn"><span class="glyphicon glyphicon-plus"></span>Agregar Grupo</asp:HyperLink>
    </p>
    <form runat="server">
