<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditarTurno.aspx.cs" Inherits="Vista.View.EditarTurno" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active">Editar Turno</li>
        </ol>
    </div>
    <h2>Turno</h2>
    <p>
        ...
        <table style="width: 81%;" class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:ObjectDataSource ID="ObjectVehiculo" runat="server" SelectMethod="ListarVehiculos" TypeName="Vista.View.EditarTurno"></asp:ObjectDataSource>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:ObjectDataSource ID="ObjectChofer" runat="server" SelectMethod="ListarChoferes" TypeName="Vista.View.EditarTurno"></asp:ObjectDataSource>
                </td>
                <td>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    ...
                    <asp:ObjectDataSource ID="ObjectGasto" runat="server" SelectMethod="ListarGastos" TypeName="Vista.View.EditarTurno"></asp:ObjectDataSource>
                </td>
                <td>
                  </td>
            </tr>
                ...
                <td>
                    ...
                    <asp:ObjectDataSource ID="ObjectEmpresa" runat="server" SelectMethod="ListarEmpresas" TypeName="Vista.View.EditarTurno"></asp:ObjectDataSource>
                    <br />
