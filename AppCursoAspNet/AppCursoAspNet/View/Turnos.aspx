...
<asp:content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Turnos</h2>
    <p>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/View/NuevoTurno.aspx" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>Agregar Turno</asp:HyperLink>
    </p>
