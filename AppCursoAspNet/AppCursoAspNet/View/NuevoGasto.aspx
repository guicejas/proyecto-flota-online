...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 81%;" class="table table-hover">
        ...
        <tr>
            ...
            <td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Ingrese un monto" ControlToValidate="monto" CssClass="alert-danger" ></asp:RequiredFieldValidator>
                <br />
        ...
        <tr>
            ...
            <tr visible ="false" id="boxFechaInfraccion" runat="server">
                ...
                <td><input id="txtFechaInfraccion" runat="server" type="date" name="fecha0"/>
                    </td>
                <td>
                    </td>
                </tr>
        ...
        <tr>
            ...
            <td>
             ...
             <td><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Debe seleccionar un Vehículo" ControlToValidate="DlVehiculo" CssClass="alert-danger"></asp:RequiredFieldValidator></td>
            <td style="width: 37px">
                <br />
            </td>
        </tr>
