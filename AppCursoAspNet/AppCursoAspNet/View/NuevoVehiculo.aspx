<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NuevoVehiculo.aspx.cs" Inherits="Vista.View.NuevoVehiculo" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Alta de Vehiculo</h2>
     <p>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/View/Vehiculo.aspx">Volver</asp:HyperLink>
    </p>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Patente" runat="server" CssClass="form-control"  MaxLength="7"></asp:TextBox>
        ...
        <tr>
            ...
            <td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Ingrese una Patente de Taxi" ControlToValidate="PatenteTaxi" CssClass="alert-danger" ></asp:RequiredFieldValidator>
             <br/>
        ...
        <tr>
            ...
            <td><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Ingrese una Marca" ControlToValidate="Marca" CssClass="alert-danger" ></asp:RequiredFieldValidator>
                <br />
