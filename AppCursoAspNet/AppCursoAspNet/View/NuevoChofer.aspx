<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NuevoChofer.aspx.cs" Inherits="Vista.View.NuevoChofer" %>
        ...
        <table style="width: 81%;" class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br />
                    <asp:RangeValidator ID="RangeValidator1" Type="Integer" ControlToValidate="Documento" runat="server" ErrorMessage="El documento debe ser un número entero" CssClass="alert-danger" MaximumValue="99999999" MinimumValue="1"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
                <td>Nombre
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Ingrese Nombre" ControlToValidate="Nombre" CssClass="alert-danger"></asp:RequiredFieldValidator>
                    <br />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Ingrese Apellido" ControlToValidate="Apellido" CssClass="alert-danger"></asp:RequiredFieldValidator>
                    <br />
